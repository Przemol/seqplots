...
\item
  \texttt{A4} - A4 portrait: - 8.27" × 11.69"
\item
  \texttt{Letter} - US Letter portrait: 8.5" × 11"
\item
  \texttt{Legal} - US Legal portrait: 8.5" × 14"
\item
  \texttt{Executive} - a.k.a Monarch paper: 7.25 × 10.5"
\end{itemize}
