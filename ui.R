...
###############################################################################
            ...
            #singleton(tags$link(rel="stylesheet", type="text/css", href="http://cdn.datatables.net/tabletools/2.2.1/css/dataTables.tableTools.css")),
						...
						singleton(tags$script(src = "http://cdn.datatables.net/1.10.0/js/jquery.dataTables.js")),
						...
						singleton(tags$script(src = "http://cdn.datatables.net/tabletools/2.2.1/js/dataTables.tableTools.min.js")),
